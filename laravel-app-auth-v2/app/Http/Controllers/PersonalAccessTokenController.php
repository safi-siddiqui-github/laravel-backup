...
class PersonalAccessTokenController extends Controller
{
    ...
    public function storeAllowRegisterUser(Otp $otp): NewAccessToken
    {
        return $otp->createToken(
            name: $this->name(),
    ...
    public function storeAllowGeneralUser(User $user): NewAccessToken
    {
        return $user->createToken(
            name: $this->name(),
            abilities: [PersonalAccessTokenAbilityEnum::ALLOW_GENERAL_USER->value],
            expiresAt: $this->expires_at,
        );
    }
}

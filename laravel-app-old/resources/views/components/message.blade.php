...
<div class="flex items-center justify-center py-5">
    ...
    <div class="flex items-center gap-2 bg-black rounded text-white text-sm py-1 pr-4 pl-2 ">
...
<div class="flex items-center justify-center py-5">
    ...
    <div class="flex items-center gap-2 bg-orange-500 rounded text-white text-sm py-1 pr-4 pl-2 ">
